...
namespace HADocsOpenData.Specification {
    ...
    public class BatchDocLineSpec {
        ...
        public double? MarkerAtPercentageFromTop = 30; //A percentage of the height (from the top of the page) to mark as an identifier for where the relevant information can be found.
